...
> Tento soubor čte Codex automaticky při startu v této složce.
> Doplňuje globální `~/.Codex/AGENTS.md` (sdílený VPS, obecná
...
- Vzorem konvencí je **Evidence nářadí** (`C:\Codex\evidence_naradi`) —
